...
Style: Quran,${arabicFontName},${arabicFontSize},&H00FFFFFF,&H0000D7FF,&H00101010,&H90000000,0,0,0,0,100,100,0,0,1,4,1,5,70,70,0,1
Style: Translation,${translationFontName},${translationFontSize},&H00FFFFFF,&H00FFFFFF,&H00101010,&H90000000,0,0,0,0,100,100,0,0,1,3,1,5,90,90,0,1
...
`;
  ...
  for (const word of words) {
    ...
    events.push(
      `Dialogue: 0,${start},${end},Quran,,0,0,0,,{\\an5\\pos(${arabicPosition.x},${arabicPosition.y})}${contextLine(word, index, wordsPerCaption)}`,
    );
    events.push(
      `Dialogue: 1,${start},${end},Translation,,0,0,0,,{\\an5\\pos(${translationPosition.x},${translationPosition.y})}${escapeAss(word.wordTranslation)}  •  ${word.verseKey}`,
    );
  }
